...
<template>
  <RouterLink :to="{ name: 'singleBook', params: { bookId: props.book.id } }">
    <span class="inline-flex">
      ...
      <span class="bg-primary text-primary-contrast p-1 px-2 flex items-center justify-center">
        {{ props.book.title }}
      </span>

      <span
        class="border-e-2 border-y-2 border-primary rounded-e-full bg-primary-contrast text-primary p-1 px-2 flex items-center justify-center gap-1"
      >
