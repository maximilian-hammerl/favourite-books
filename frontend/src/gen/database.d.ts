...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      book_has_book_subgenre: {
        Row: {
          book_id: string
          book_subgenre_id: string
          created_at: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: 'book_has_book_subgenre_book_id_fkey'
            columns: ['book_id']
            isOneToOne: false
            referencedRelation: 'book'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'book_has_book_subgenre_book_subgenre_id_fkey'
            columns: ['book_subgenre_id']
            isOneToOne: false
            referencedRelation: 'book_subgenre'
            referencedColumns: ['id']
          },
        ]
      }
